...
if __name__ == '__main__':
    ...
    for index in range(10):
        ...
        log.write_to_file(PATH, index, **stat_data_of_generation)
    ...
    visualization.get_plot_of_optimization(global_data_for_plot['global_min_history'], global_data_for_plot['global_avg_history'])
